  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end justify-center px-4 pb-6 sm:items-center sm:pb-0">
      ...
      <div className="relative w-full max-w-md rounded-3xl border border-zinc-200 bg-white p-6 shadow-xl">
        ...
        <input
          className="mt-4 w-full rounded-2xl border border-zinc-200 px-4 py-2 text-sm outline-none transition focus:border-zinc-900"
        ...
        >
          ...
          <div className="mt-2 flex gap-2">
            <input
              className="flex-1 rounded-xl border border-zinc-200 px-3 py-2 text-sm outline-none transition focus:border-zinc-900"
              value={newName}
